...
export type PublicApiType = {
  db: {
    patterns: {
      ...
      >
      get: FunctionReference<'query', 'public', { apiKey?: string; id: string }, any>
      ...
      >
      remove: FunctionReference<'mutation', 'public', { apiKey?: string; id: string }, any>
    ...
    texts: {
      deletePrompt: FunctionReference<'mutation', 'public', { _id: Id<'texts'>; apiKey?: string }, any>
    ...
    threads: {
      ...
      >
      remove: FunctionReference<'mutation', 'public', { apiKey?: string; threadId: string }, null>
      update: FunctionReference<
        'mutation',
        'public',
        {
    ...
    users: {
      generateNewApiKey: FunctionReference<'mutation', 'public', { apiKey?: string }, any>
    ...
    messages: {
      ...
      >
      remove: FunctionReference<'mutation', 'public', { apiKey?: string; messageId: string }, null>
      update: FunctionReference<
        'mutation',
        'public',
        {
    ...
    metadata: {
      getMetadata: FunctionReference<'query', 'public', { apiKey?: string; id: string; route: string }, any>
    }
    models: {
      listChatModels: FunctionReference<'query', 'public', { apiKey?: string }, any>
    }
    admin: {
      events: {
        ack: FunctionReference<'mutation', 'public', { apiKey?: string; id: Id<'operationsEventLog'> }, any>
        latest: FunctionReference<'query', 'public', { apiKey?: string; limit?: number }, any>
      }
      see: {
    ...
    audio: {
      ...
      >
      getByMessageId: FunctionReference<'query', 'public', { apiKey?: string; messageId: Id<'messages'> }, any>
    }
    collections: {
      create: FunctionReference<
        'mutation',
      ...
      >
      remove: FunctionReference<'mutation', 'public', { apiKey?: string; collectionId: string }, any>
      update: FunctionReference<
        'mutation',
        'public',
        {
