...
import { ChatModel } from '@corale/api'
  ...
  return (
    <PageLayout
      header={
        <PageHeader>
          <SidebarTrigger />
          <span className="text-sm font-medium">Models List</span>
        ...
        <Table className="overflow-y-auto">
          <TableHeader className="bg-gray-2 sticky top-0 z-10 text-xs">
            <TableRow>
              ...
              <TableHead className="cursor-pointer select-none text-right" onClick={() => handleSort('contextLength')}>
          ...
          <TableBody>
            {filteredAndSortedModels.map((model) => (
              <TableRow key={model._id}>
                ...
                <TableCell className="w-[12ch] tabular-nums">
