...
import type { ImageReturn } from './entities/images/validators'
import type { RunReturn } from './entities/runs/validators'
import type { TextToImageInputs } from './entities/shared'
import type { UserReturn } from './entities/users/validators'
...
export type EImage = Infer<AsObjectValidator<typeof ImageReturn>>
export type EUser = Infer<AsObjectValidator<typeof UserReturn>>
export type ERun = Infer<AsObjectValidator<typeof RunReturn>>
