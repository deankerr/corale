...
export function PanelGroup({ children, className }: { children?: React.ReactNode; className?: string }) {
  return <div className={cn('flex h-full min-h-0 divide-x', className)}>{children}</div>
}

export function PanelStack({ children, className }: { children?: React.ReactNode; className?: string }) {
