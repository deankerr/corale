  ...
  return (
    <div className="z-20 hidden w-11 shrink-0 md:block [&:has(button[data-state=on])]:w-60">
      <Navigation className="w-11 rounded-md border transition-all hover:w-60 [&:has(button[data-state=on])]:w-60">
        <Toggle.Root className="text-gray-11 outline-accent-a8 hover:bg-gray-a2 data-[state=on]:text-accent-11 absolute left-48 top-1 z-10 flex size-10 items-center justify-center rounded">
