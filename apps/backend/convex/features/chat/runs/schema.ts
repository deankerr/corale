import { omit, pick, v } from '~/common'
import { MessageRoles, ModelParameters } from '~/entities/shared'
import { MessageCreate } from '~/entities/threads/messages/models'
import { defineEnt } from 'convex-ents'

export const RunSchemaFields = {
  status: v.literals('queued', 'active', 'done', 'failed'),
  stream: v.boolean(),
